...
async function seedTours() {
  ...
  const sampleTours = [
    /* ── Tour 01 — Cultural Tour Package ─────────────────────────────────── */
    {
      ...
      available: true,
      highlights: [
        { text: "Climb the iconic Sigiriya Rock Fortress (UNESCO World Heritage Site)", featured: true },
        { text: "Enjoy an authentic Sigiriya village tour with local transport and cooking", featured: true },
        { text: "Explore the Dambulla Cave Temple with golden Buddha statues and ancient murals", featured: true },
        { text: "Visit the Temple of the Sacred Tooth Relic in the royal city of Kandy", featured: true },
        { text: "Attend a vibrant Kandy Cultural Dance Show", featured: true },
        { text: "Tour a tea factory and plantation in the misty Nuwara Eliya highlands", featured: true },
        { text: "Discover the Buduruwagala rock-carved Buddha statues", featured: false },
        { text: "Walk across the iconic Nine Arches Bridge in Ella", featured: false },
        { text: "Hike to Little Adam\u2019s Peak for breathtaking valley panoramas", featured: false },
        { text: "Marvel at the cascading Ravana Falls", featured: false },
        { text: "Spot leopards, elephants, crocodiles, and exotic birds at Yala National Park", featured: false },
        { text: "Seamless airport pick-up and drop-off", featured: false },
      ],
    ...
    },
    {
      ...
      available: true,
      highlights: [
        { text: "Climb Sigiriya Rock Fortress at sunrise", featured: true },
        { text: "Temple of the Tooth Relic in Kandy", featured: true },
        { text: "Scenic train ride through tea country", featured: true },
        { text: "Nine Arches Bridge at Ella", featured: true },
        { text: "Galle Fort colonial walk", featured: true },
        { text: "Blue whale watching at Mirissa", featured: true },
      ],
      heroImage: "/images/sigiriya-hero.jpg",
    ...
    },
    {
      ...
      available: true,
      highlights: [
        { text: "Yala National Park leopard safari", featured: true },
        { text: "Minneriya elephant gathering", featured: true },
        { text: "Blue whale watching boat trip", featured: true },
        { text: "Udawalawa elephant orphanage", featured: true },
        { text: "Bird watching in Bundala", featured: true },
      ],
    ...
    },
    {
      ...
      available: true,
      highlights: [
        { text: "Sigiriya Rock Fortress (UNESCO)", featured: true },
        { text: "Dambulla Cave Temple (UNESCO)", featured: true },
        { text: "Ancient city of Anuradhapura (UNESCO)", featured: true },
        { text: "Polonnaruwa ruins (UNESCO)", featured: true },
        { text: "Traditional village experience", featured: true },
      ],
  ...
  for (const tour of sampleTours) {
    const { whatsIncluded: inc, whatsExcluded: exc, ...rest } = tour as typeof tour & {
    ...
    await db
      ...
      .values({
        ...rest,
        whatsIncluded: inc ?? defaultIncluded,
        whatsExcluded: exc ?? defaultExcluded,
