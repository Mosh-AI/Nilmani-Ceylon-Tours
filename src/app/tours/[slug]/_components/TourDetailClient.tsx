...
/* ── Gallery Strip ── */
function GalleryStrip({ images }: { images: { src: string; alt: string }[] }) {
      ...
      <section className="relative flex h-[60vh] items-end overflow-hidden sm:h-[70vh] lg:h-[85vh]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-10 lg:px-12 lg:pb-14">
          ...
          <div className="inline-flex items-center gap-3 rounded-full bg-white/95 px-5 py-2.5 shadow-lg backdrop-blur-sm">
            ...
            <span className="text-xs text-brand-muted">{tour.priceNote}</span>
          </div>
        </div>
      </section>
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <div className="rounded-2xl border border-brand-border bg-white p-6 shadow-sm">
                ...
                <p className="mb-6 text-xs text-brand-muted">{tour.priceNote}</p>
